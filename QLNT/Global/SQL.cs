...
namespace QLNT.Global
{
    class SQL
    {
        ...
        private static string connectString = @"Data Source=DESKTOP-O8448GN;Initial Catalog=QLNT;Integrated Security=True";
        //private static string connectString = @"Data Source=.\SQLEXPRESS;AttachDbFilename=" + path + ";Integrated Security=True;Connect Timeout=30;User Instance=True";
